...
def parse_args():
    ...
    parser.add_argument('--src_dir', type=str, default='/mnt/sdb1/swf/data/UCF101/videos/')
    parser.add_argument('--out_dir', type=str, default="/mnt/sdb1/swf/data/UCF101/rawframes")
