...
import argparse
import os
os.environ["CUDA_VISIBLE_DEVICES"] = "1"  # 指定只使用第二张显卡进行训练
...
def parse_args():
    ...
    parser.add_argument(
        ...
        '--config',
        type=str,
        default='/mnt/sdb1/swf/project/PaddleVideo/configs/recognition/pptsm/pptsm_task_VideoClassfy_frames_dense_ucf24.yaml',
        help='config file path')
    parser.add_argument(
        '-o',
        '--override',
    ...
    # parser.add_argument("-i", "--input_file", type=str, default="/mnt/sdb1/swf/data/UCF24/rgb-images", help="input file path")
    parser.add_argument("-i", "--input_file", type=str, default="/mnt/sdb1/swf/data/UCF24/ucf24_val_split_1_rawframes.txt", help="input file path")
    parser.add_argument(
        "--time_test_file",
        type=str2bool,
        default=False,
    ...
    parser.add_argument("--model_file", type=str, default="/mnt/sdb1/swf/project/PaddleVideo/output/ppTSM_task_VideoClassfy_frames_dense_no_pretrained_ucf24/ppTSM_task_VideoClassfy_frames_dense_no_pretrained_ucf24_best.pdopt")
    parser.add_argument("--params_file", type=str, default="/mnt/sdb1/swf/project/PaddleVideo/output/ppTSM_task_VideoClassfy_frames_dense_no_pretrained_ucf24/ppTSM_task_VideoClassfy_frames_dense_no_pretrained_ucf24_best.pdparams")
