...
def parse_args():
    ...
    parser.add_argument('-c',
                        ...
                        default='configs/recognition/pptsm/pptsm_task_VideoClassfy_frames_dense_ucf24.yaml',
    ...
    parser.add_argument('-w',
                        '--weights',
                        type=str,
                        # default="/mnt/sdb1/swf/project/PaddleVideo/output/ppTSM_task_VideoClassfy_frames_dense_no_pretrained_ucf24/ppTSM_task_VideoClassfy_frames_dense_no_pretrained_ucf24_best.pdopt",
                        default="/mnt/sdb1/swf/project/PaddleVideo/output/ppTSM_task_VideoClassfy_frames_dense_no_pretrained_ucf24/ppTSM_task_VideoClassfy_frames_dense_no_pretrained_ucf24_best.pdparams",
