...
def parse_args():
    ...
    parser.add_argument('-c',
                        '--config',
                        type=str,
                        default='/mnt/sdb1/swf/project/PaddleVideo/configs/recognition/pptsm/pptsm_task_VideoClassfy_frames_dense_hmdb51.yaml',
                        help='config file path')

    # parser.add_argument('--video_path', help='video file/url')
    parser.add_argument('--video_path', default="/mnt/sdb1/swf/data/hmdb51/hmdb51_orgin/brush_hair/April_09_brush_hair_u_nm_np1_ba_goo_0.avi", help='video file/url')
    ...
    parser.add_argument('-w',
                        '--weights',
                        type=str,
                        default="/mnt/sdb1/swf/project/PaddleVideo/output/ppTSM_task_VideoClassfy_frames_dense_no_pretrained_hmdb51/ppTSM_task_VideoClassfy_frames_dense_no_pretrained_hmdb51_best.pdopt",
                        help='weights for finetuning or testing')
